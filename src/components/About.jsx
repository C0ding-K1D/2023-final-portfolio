        ...
        >
          ...
          <div className="iconContainer">
            <div className="innerIconContainer">
              <a href="https://medium.com/@Matthew_Alvarez" target="_blank">
                <img src={medium} alt="" className="medium-icon" />
              </a>
              <a href="https://github.com/C0ding-K1D" target="_blank">
                <GitHubIcon
                  style={{
                    color: "rgba(94, 197, 118, 0.667)",
                  }}
                  fontSize="large"
                />
              </a>
          ...
          <Button
            variant="contained btn-contact_about"
            size="large"
